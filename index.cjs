...
readline.question('Enter the amount of USD you want to convert: ', (amountUSD) => {
    readline.question('Enter the currency you want to convert to (EUR, GBP, or CAD): ', (targetCurrency) => {
        // Convert the amount of USD to the target currency based on the user's input
        let amountTargetCurrency;
